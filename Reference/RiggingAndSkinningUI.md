...
- Existing Skeleton is the skeleton we want to retarget/base the new Skeletal Mesh to for animation compatibility, or 
  leave blank to generate new default skeleton based on the chosen template.  Conforms to UE bone rotation convention
## Mesh
